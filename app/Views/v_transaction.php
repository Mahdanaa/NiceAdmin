    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url('transaction/delete/' . $item['rowid'] . '') ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
        <?php
            endforeach;
...
<a class="btn btn-warning" href="<?php echo base_url() ?>transaction/clear">Kosongkan Keranjang</a>
